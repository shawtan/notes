...
#### Location
- Can be
    - Nominal: expressed in terms of names
    - Absolute: expressed in terms of coordinates
        - Latitude = how north / south
        - Longitude = how east / west
    - Relative: in terms of site or situation
...
- **Friction of distance**: deterrent / inhibiting effect of distance on human activity
- **Distance-decay function**: rate where an activity decreases with distance
...
- Principles
    - Complementarity
        1. Demand and supply must match
...
- **Symbolic** lanscape: particular values / aspirations leaders want to impart on the public

#### Sense of Place
- People's feelings towards a place due to experiences and memories
- Insiders
...
- Census: Count of people in a country / region / city
    - Lots of data
    - Only a snapshot
- Vital record: reports of birth, death, marriage, divorce, disease
    - Limited individuals
...
- Variations
    - Infant mortality rate: infants < 1 year / 1000 live births
...
- Fertility and mortality rates are tied to level of economic development
- **Demographic Transition**: Model where high birth and death rates become low birth and death rates
...
- e.g China One Child Policy (1979 - 2014)
